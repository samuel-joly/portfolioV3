...
<div class='d-flex col-lg-12 col-md-12 col-11 row justify-content-lg-center justify-content-sm-center p-0 ' style='min-height:15em;'>
	...
	<div class='col-12 row m-0 p-0 d-flex justify-content-center'>
		...
		<div class='row col-lg-9 col-12 d-flex justify-content-start align-items-start btn-group btn-group-toggle mb-4' data-toggle='buttons' id='project-type'>
			<label class='btn btn-secondary col-lg-1 col-2 d-flex align-items-center justify-content-center' style='font-size:0.8em;height:1.7em;'>
				<input type='radio' name='project-option' id='' checked>Tout
			</label>

			<label class='d-flex justify-content-center align-items-center  btn btn-secondary col-lg-1 col-2' style='font-size:0.8em;height:1.7em;'>
				<input type='radio' name='project-option' id='1'>Site
			</label>

			<label class='d-flex justify-content-center align-items-center  btn btn-secondary col-lg-1 col-2 ' style='font-size:0.8em;height:1.7em;'>
				<input type='radio' name='project-option' id='2'>Jeux
			</label>

			<label class='d-flex justify-content-center align-items-center  btn btn-secondary col-lg-1 col-2' style='font-size:0.8em;height:1.7em;'>
				<input type='radio' name='project-option' id='3'>Programes
			</label>
